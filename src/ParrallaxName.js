      ...
      >
        ...
        <Parallax class="bgImage" bgImage={require("../src/woods/4.png")}>
          ...
          <div style={{ height: 800 }} class="container">
            ...
            <animated.div
              class="card4"
              style={{ transform: props.xy.interpolate(trans2_1) }}
            >
            ...
            <animated.div
              class="card4"
              style={{ transform: props.xy.interpolate(trans2_2) }}
            >
            ...
            <animated.div
              class="card4"
              style={{ transform: props.xy.interpolate(trans2_3) }}
            >
            ...
            <animated.div
              class="card4"
              style={{ transform: props.xy.interpolate(trans3_1) }}
            >
              <p style={{ fontSize: "100px", color: "green", opacity: "80%" }}>
                My Name is
              </p>
            ...
            <animated.div
              class="card4"
              style={{ transform: props.xy.interpolate(trans3_2) }}
            >
              <p style={{ fontSize: "100px", color: "red", opacity: "80%" }}>
                My Name is
              </p>
            ...
            <animated.div
              class="card4"
              style={{ transform: props.xy.interpolate(trans3_3) }}
            >
